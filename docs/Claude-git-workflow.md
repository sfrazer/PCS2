...
1. Run the full GUT test suite headlessly: `scripts/run_tests.sh`. It must exit 0 — all tests pass. This gate runs *before* review; a red suite blocks the PR. See `wiki/testing.md`.
2. Run the Ollama code review:
